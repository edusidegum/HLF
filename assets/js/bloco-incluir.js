...
// Topbar CSS (injeta antes do HTML para evitar FOUT)
var link = document.createElement('link');
link.rel = 'stylesheet';
link.href = BASE + 'assets/css/topbar.css?v=' + Date.now();
document.head.appendChild(link);
// Topbar HTML (menu universal)
injetar('compartilhado/topbar.html', '#topbar-placeholder', 'afterbegin');
// Banner de cookies
...
document.addEventListener('click', function(e) {
var btn = e.target.closest('.topbar-toggle');
if (btn) {
