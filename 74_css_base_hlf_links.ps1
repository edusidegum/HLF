...
$CssFile = "D:\GitHub\HLF\assets\css\links.css"; $CssDir = Split-Path $CssFile -Parent
...
h2 { font-size:clamp(1.2rem,3vw,1.8rem); margin-top:20px; }
...
@media(max-width:640px) { .container,.wrapper,.content,main,section>div { width:min(100% - 24px,var(--maxw)); } }
"@
